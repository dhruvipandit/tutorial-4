...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\student\\Desktop\\dhruvi Lab in psy\\motor sequence learning_lastrun.py',
...
trials = data.TrialHandler(nReps=24.0, method='sequential', 
    ...
    trialList=data.importConditions('C:/Users/student/Desktop/dhruvi Lab in psy/sequence_cond.csv'),
